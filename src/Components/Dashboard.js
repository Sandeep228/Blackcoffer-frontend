...
import { Box, Typography, Card } from "@mui/material"; // Use PascalCase for Material-UI components
...
const Dashboard = () => {
  ...
  const CardStyle = styled(Card)({
    // Use PascalCase for Material-UI components
    background: colorBlack === true ? "#36454F" : "white",
